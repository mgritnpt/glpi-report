      ...
      <div className="main-grid" style={{ display: 'grid', gridTemplateColumns: '1.1fr 2fr', gap: '1.5rem', alignItems: 'start' }}>
        ...
        <div className="card no-print" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', padding: '1.25rem' }}>
          ...
          <div style={{
            ...
            <span>ใบรับมอบนี้ออกแบบมาเพื่อจัดทำเอกสารส่งมอบ-รับคืนคอมพิวเตอร์ A4 แผ่นเดียว โดยข้อมูลในส่วนที่ 2 (ส่งคืน) จะพิมพ์ว่างไว้เพื่อให้เขียนและเช็กด้วยลายมือเมื่อพนักงานคืนเครื่องในอนาคต</span>
          </div>
        </div>
                    ...
                    <div className="part-section" style={{ border: '1px solid #e2e8f0', borderRadius: '4px', padding: '6px 10px', backgroundColor: '#fdfdfd' }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '6px', padding: '6px 8px', backgroundColor: '#f8fafc', border: '1px solid #cbd5e1', borderRadius: '3px', fontSize: '10.5px' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          <div style={{ width: '150px', fontWeight: 700 }}>วันที่ส่งคืน (Return Date):</div>
                          <div style={{ color: '#475569' }}>............ / ............ / ........................</div>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          <div style={{ width: '150px', fontWeight: 700 }}>เหตุผลการส่งคืน (Reason):</div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                          <div style={{ width: '150px', fontWeight: 700 }}>สภาพอุปกรณ์ตอนคืน (Condition):</div>
                          <div style={{ display: 'flex', gap: '15px' }}>
                      ...
                      <div style={{ fontSize: '10px', color: 'var(--danger)', marginBottom: '6px', fontWeight: 700 }}>
                        *กรณีส่งมอบไม่ครบ หรืออุปกรณ์ชำรุดเสียหาย จะต้องชำระค่าเสียหาย จำนวน ............................................................ บาท
                      </div>
